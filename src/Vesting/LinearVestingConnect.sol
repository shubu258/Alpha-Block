...
contract LinearVestingFactory {
    ...
    function createVesting(
        ...
        LinearVesting v = new LinearVesting(
            _beneficiary,
            _totalTokens,
            _startTime,
            _duration
    ...
    function createInvestor(/* address token, */ address _beneficiary, uint256 _totalTokens, uint256 _startTime, uint256 _duration)
        external onlyOwner returns (address)
    { return createVesting(_beneficiary, _totalTokens, _startTime, _duration); }

     function createDeveloper(/* address token, */ address _beneficiary, uint256 _totalTokens, uint256 _startTime, uint256 _duration)
        external onlyOwner returns (address)
    { return createVesting(_beneficiary, _totalTokens, _startTime, _duration); }

     function createMarketing(/* address token, */ address _beneficiary, uint256 _totalTokens, uint256 _startTime, uint256 _duration)
        external onlyOwner returns (address)
    { return createVesting(_beneficiary, _totalTokens, _startTime, _duration); }

     function createCommunity(/* address token, */ address _beneficiary, uint256 _totalTokens, uint256 _startTime, uint256 _duration)
        external onlyOwner returns (address)
    { return createVesting(_beneficiary, _totalTokens, _startTime, _duration); }

     function createReserve(/* address token, */ address _beneficiary, uint256 _totalTokens, uint256 _startTime, uint256 _duration)
        external onlyOwner returns (address)
    { return createVesting(_beneficiary, _totalTokens, _startTime, _duration); }
