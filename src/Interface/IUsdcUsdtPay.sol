...
interface IUsdcUsdtPay {
    ...
    function buyFromUsdt(uint256 tokenAmount, uint256 tokenDecimals, uint256 tokenPriceUsdt)
        external
        pure
        returns (uint256);
    ...
    function buyFromUsdc(uint256 tokenAmount, uint256 tokenDecimals, uint256 tokenPriceUsdc)
        external
        pure
        returns (uint256);
    ...
    function buyTokenNative(uint256 tokenAmount, uint256 tokenDecimals, address nativeCurrency)
        external
        view
        returns (uint256);
